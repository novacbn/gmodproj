...
return r(e,"\n")end
GamemodeTemplate=a:extend({createProject=function(e)e:createDirectory("gamemodes")e:createDirectory("gamemodes/"..tostring(e.projectName))e:createDirectory("gamemodes/"..tostring(e.projectName).."/gamemode")e:createDirectory("src")e:write("gamemodes/"..tostring(e.projectName).."/"..tostring(e.projectName)..".txt",o(e.projectName))e:write("gamemodes/"..tostring(e.projectName).."/gamemode/cl_init.lua",t(nil,{tostring(e.projectName).."_client.lua"}))e:write("gamemodes/"..tostring(e.projectName).."/gamemode/init.lua",t({"cl_init.lua",tostring(e.projectName).."_client.lua"},{tostring(e.projectName).."_server.lua"}))local n=e.projectAuthor.."/"..e.projectName
e:write("src/client.lua","imp".."ort('"..tostring(n).."/shared').sharedFunc()\nprint('I was called on the client!')")e:write("src/server.lua","imp".."ort('"..tostring(n).."/shared').sharedFunc()\nprint('I was called on the server!')")e:write("src/shared.lua","function sharedFunc()\n\tprint('I was called on the client and server!')\nend")return e:writeProperties(".gmodmanifest",{name=e.projectName,author=e.projectAuthor,version="0.0.0",repository="unknown://unknown",buildDirectory="gamemodes/"..tostring(e.projectName).."/gamemode",projectBuilds={[tostring(n).."/client"]=tostring(e.projectName).."_client",[tostring(n).."/server"]=tostring(e.projectName).."_server"}})end})end,['novacbn/gmodproj-plugin-builtin/templates/PackageTemplate']=function(e,e,e,e,...)local l
...
PackageTemplate=l:extend({createProject=function(e)e:createDirectory("dist")e:createDirectory("src")e:write("src/main.lua",t(e.projectAuthor,e.projectName))return e:writeProperties(".gmodmanifest",{name=e.projectName,author=e.projectAuthor,version="0.0.0",repository="unknown://unknown",projectBuilds={[tostring(e.projectAuthor).."/"..tostring(e.projectName).."/main"]=tostring(e.projectAuthor).."_"..tostring(e.projectName)}})end})end,['rxi/json/main']=function(e,c,e,e,...)c._version="0.1.1"local t
